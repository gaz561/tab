{:name "somewhere in Honeyfern Labs"
 :base [:teraum/eastlands/green-delta/game/south-arathel/area
        :teraum/eastlands/green-delta/game/south-arathel/honeyfern/honeyfern]
 :trivia ["Prior to the Break, Honeyfern Labs was the home and library of Lorrestar, a famous magic-using human."
